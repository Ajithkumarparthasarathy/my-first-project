...
ActiveRecord::Schema.define(version: 2022_01_20_092036) do
  ...
  create_table "loggings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["email"], name: "index_loggings_on_email", unique: true
    t.index ["reset_password_token"], name: "index_loggings_on_reset_password_token", unique: true
  end
